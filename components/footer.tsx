  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <h3 className="text-2xl sm:text-3xl font-bold mb-4">Stay in the loop</h3>
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Get notified about the hottest events and exclusive deals before anyone else.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            />
            <Button className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-full px-8 py-3 font-semibold">
              Subscribe
            </Button>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <span className="text-2xl font-bold">Ticket-er</span>
            </motion.div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              The ultimate platform for discovering, buying, and selling event tickets. Making unforgettable experiences
        ...
        >
          <p className="text-gray-400 text-sm mb-4 sm:mb-0">
            © {new Date().getFullYear()} Ticket-er. All rights reserved.
          </p>
